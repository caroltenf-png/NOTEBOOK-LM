---
description: Detectar vazamento de memoria em servico de longo prazo (Node.js, Python, Go, etc), identificar o retentor que esta segurando objetos alem do necessario, e corrigir sem chute.
argument-hint: [contexto opcional]
---

<!-- TurmCode / 47 Prompts Avancados — Caca ao Memory Leak -->
