---
description: Fazer o Claude construir, em uma unica sessao, um entendimento real de um codebase que ele nunca viu — arquitetura, fluxos, pontos de entrada, dependencias chave — e gerar um do...
argument-hint: [contexto opcional]
---

<!-- TurmCode / 47 Prompts Avancados — Onboarding do Claude em Projeto Existente -->
