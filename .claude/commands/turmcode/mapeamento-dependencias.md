---
description: Produzir um inventario real das dependencias externas do projeto (nao apenas `package.json`), classificando-as por criticidade, uso real no codigo, risco e alternativas.
argument-hint: [contexto opcional]
---

<!-- TurmCode / 47 Prompts Avancados — Mapeamento Completo de Dependencias -->
