---
description: Rodar uma auditoria pragmatica orientada ao OWASP Top 10 (web) sobre o projeto ou um diff, identificando achados concretos com arquivo:linha, nao alertas genericos de livro.
argument-hint: [contexto opcional]
---

<!-- TurmCode / 47 Prompts Avancados — Auditoria de Seguranca (OWASP Top 10) -->
